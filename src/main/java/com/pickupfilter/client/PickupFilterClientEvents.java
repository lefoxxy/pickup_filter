...
public final class PickupFilterClientEvents {
    ...
    public static final class ForgeBusEvents {
        ...
        public static void onInventoryScreenInit(ScreenEvent.Init.Post event) {
            ...
            Button button = Button.builder(Component.translatable("button.pickupfilter.open"), clickedButton -> PickupFilterNetwork.sendOpenMenu())
                    .bounds(x, y, 18, 18)
                    .tooltip(Tooltip.create(Component.translatable("button.pickupfilter.open.tooltip")))
