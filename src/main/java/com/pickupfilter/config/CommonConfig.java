package com.pickupfilter.config;
...
public final class CommonConfig {
    ...
    static {
        ...
        DEFAULT_MODE = builder
                .comment("Default filter mode for players who do not have saved Pickup Filter data yet.")
                .defineEnum("defaultMode", FilterMode.BLACKLIST);
        DEFAULT_FEEDBACK_ENABLED = builder
                .comment("Default actionbar feedback setting for players who do not have saved Pickup Filter data yet.")
        ...
        ENABLE_INVENTORY_BUTTON = builder
                .comment("Adds a small Pickup Filter button to the vanilla player inventory screen.")
                .define("enableInventoryButton", true);
        ENABLE_KEYBIND_FALLBACK = builder
                .comment("Allows the configurable Open Pickup Filter keybind to open the GUI.")
